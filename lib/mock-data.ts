...
export const mockProducts: Product[] = [
  {
    ...
    stock: 80,
    material:
      "국내산 면 100% 6겹 거즈\n\n거즈는 실을 성기게 직조한 평직 원단으로, 겹칠수록 공기층이 생겨 한 장의 두꺼운 천보다 부드럽고 흡수력이 높습니다. Amori의 거즈 빕은 6겹 구조로 직조되어 침, 분유, 이유식 등을 효과적으로 흡수하며, 세탁을 반복할수록 섬유가 살짝 수축되며 더욱 촘촘하고 포근한 질감으로 변합니다.\n\n· 소재: 면(cotton) 100%\n· 원산지: 국내산\n· KC 안전 인증 완료 (어린이제품 공통안전기준)",
    sizeGuide:
      "프리 사이즈 (신생아 ~ 24개월)\n\n· 가로 약 22cm × 세로 약 28cm\n· 목 둘레: 최대 32cm (스냅 단추 조절)\n· 신생아부터 두 돌 전까지 무리 없이 사용할 수 있는 넉넉한 사이즈입니다.\n· 이유식 시기(6개월~)에는 앞면 전체를 충분히 가려주어 옷이 젖는 것을 막아줍니다.",
    careInstructions:
      "· 세탁: 30°C 이하 찬물, 중성세제 사용\n· 단독 또는 유사 색상끼리 세탁 권장\n· 손세탁 또는 세탁기 약세탁(울 코스)\n· 건조기 사용 불가 — 수축 및 변형의 원인이 됩니다\n· 그늘에서 자연 건조\n· 직사광선 장시간 노출 시 색상이 바랄 수 있습니다\n· 처음 세탁 시 단독으로 세탁해 주세요 (이염 방지)",
    features: [
      {
        label: "6겹 거즈 구조",
        body: "단순히 두껍게 접은 것이 아닌, 6겹으로 직조된 거즈입니다. 세탁할수록 섬유가 수축되어 더 촘촘하고 부드러운 질감으로 변합니다.",
      },
      {
        label: "면 100% 국내산",
      ...
      {
        label: "넉넉한 프리 사이즈",
        body: "신생아부터 24개월까지 사용 가능한 크기입니다. 이유식 시기에도 앞면을 충분히 가려주어 옷이 젖는 것을 막아줍니다.",
      },
      {
        label: "스냅 단추 고정",
        body: "매듭이나 벨크로 없이 스냅 단추로 간편하게 착탈할 수 있습니다. 아이의 목 사이즈에 맞춰 두 단계로 조절됩니다.",
      },
    ],
    brandStory:
