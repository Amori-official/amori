    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-md max-h-[90vh] overflow-y-auto p-6 sm:p-8">
        ...
        {order.status === "delivered" && (
          <button className="mt-5 w-full h-10 border border-brand-black text-brand-black text-[14px] tracking-widest hover:bg-brand-fill hover:text-brand-black transition-colors">
            리뷰 작성
          </button>
        )}
      </div>
